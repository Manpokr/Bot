...
create_vless() {
    ...
    vlesslink4="vless://${uuid}@vlh2.${domain}:${xtls1}?security=tls%26encryption=none%26type=h2%26headerType=none%26path=%2Fvless-h2%26sni=bug.com#${user}"
    ...
    msg+="PORT TLS     = ${xtls}\n"
    msg+="PORT NONE    = ${none}\n"
    msg+="GRPC TYPE    = Gun & Multi\n"
    msg+="USER ID      = ${uuid}\n"
    msg+="\n━━━━━━━━━━━━━━━━━━━━━\n"
    msg+="VLESS WS TLS LINK\n"
    msg+="<code>$vlesslink1</code>\msgn"
    msg+="\n━━━━━━━━━━━━━━━━━━━━━\n"
    msg+="VLESS WS LINK\n"
    msg+="<code>$vlesslink2</code>\msgn"
    msg+="\n━━━━━━━━━━━━━━━━━━━━━\n"
    msg+="VLESS H2 TLS LINK\n"
    msg+="<code>$vlesslink4</code>\msgn"
    msg+="\n━━━━━━━━━━━━━━━━━━━━━\n"
    msg+="VLESS GRPC TLS LINK\n"
    msg+="<code>$vlesslink3</code>\msgn"
    msg+="\n━━━━━━━━━━━━━━━━━━━━━\n"
