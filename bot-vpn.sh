...
ShellBot.InlineKeyboardButton --button 'menu1' --line 2 --text '🔰 Voucher Generator 🔰' --callback_data '_voucherGenerator'
ShellBot.InlineKeyboardButton --button 'menu1' --line 3 --text '⚠️ Public Mode ⚠️' --callback_data '_publicMode'
ShellBot.InlineKeyboardButton --button 'menu1' --line 3 --text '🆓 Limit Free 🆓' --callback_data '_freelimit'
...
unset menuser
menuser=''
ShellBot.InlineKeyboardButton --button 'menuser' --line 1 --text 'Menu Ssh-VPN' --callback_data '_menussh'
ShellBot.InlineKeyboardButton --button 'menuser' --line 1 --text 'Menu Vless' --callback_data '_menuvless'
ShellBot.InlineKeyboardButton --button 'menuser' --line 2 --text 'Menu Vmess' --callback_data '_menuvmess'
ShellBot.InlineKeyboardButton --button 'menuser' --line 2 --text 'Menu Trojan' --callback_data '_menutrojan'
ShellBot.InlineKeyboardButton --button 'menuser' --line 3 --text 'Menu Shadowsock' --callback_data '_menuss'
ShellBot.InlineKeyboardButton --button 'menuser' --line 3 --text 'Trojan-Go' --callback_data '_menutrgo'
ShellBot.InlineKeyboardButton --button 'menuser' --line 4 --text '🔙 Back 🔙' --callback_data '_back1'
...
ShellBot.regHandleFunction --function backReq --callback_data _back1
unset keyboardser
keyboardser="$(ShellBot.InlineKeyboardMarkup -b 'menuser')"


unset menu2
menu2=''
ShellBot.InlineKeyboardButton --button 'menu2' --line 1 --text 'create Vless' --callback_data '_addvless'
ShellBot.InlineKeyboardButton --button 'menu2' --line 1 --text 'Delete Vless' --callback_data '_delconf'
ShellBot.InlineKeyboardButton --button 'menu2' --line 2 --text 'Renew Vless' --callback_data '_extconf'
...
ShellBot.InlineKeyboardButton --button 'menu4' --line 3 --text 'Voucher OVPN' --callback_data '_voucherOVPN'
ShellBot.InlineKeyboardButton --button 'menu4' --line 4 --text '🔙 Back 🔙' --callback_data '_back3'
...
ShellBot.regHandleFunction --function back_ser --callback_data _back3
unset keyboard4
keyboard4="$(ShellBot.InlineKeyboardMarkup -b 'menu4')"

unset menu5
menu5=''
ShellBot.InlineKeyboardButton --button 'menu5' --line 1 --text 'Menu Ssh-VPN' --callback_data '_menussh5'
...
ShellBot.InlineKeyboardButton --button 'menu5' --line 1 --text 'Menu Shadowsock' --callback_data '_menuss5'
ShellBot.InlineKeyboardButton --button 'menu5' --line 1 --text 'Menu Trojan-go' --callback_data '_menutrgo5'
...
ShellBot.regHandleFunction --function menu_trgo --callback_data _menutrgo5
unset keyboard5
...
ShellBot.InlineKeyboardButton --button 'menu6' --line 3 --text '🔙 Back 🔙' --callback_data '_back4'
...
unset menu9
menu9=''
ShellBot.InlineKeyboardButton --button 'menu9' --line 1 --text '🔙 Back 🔙' --callback_data '_back5'
ShellBot.regHandleFunction --function backReq --callback_data _back5
unset keyboard9
